...
//     int Lenght; // Переменная для хранения размера массива
...
//     // Открытие файла для записи случайных элементов
//     ofstream Output("F1.bin", ios_base::binary);

//     // Заполнение файла случайными элементами и вывод их на экран
//     for (int i = 0; i < Lenght; i++)
//     {
...
//     // Открытие файла для записи элементов, введенных вручную
//     Output.open("F1.bin", ios_base::binary);

//     // Заполнение файла элементами, введенными вручную
//     for (int i = 0; i < Lenght; i++)
//     {
//         int element;
//         cin >> element;
