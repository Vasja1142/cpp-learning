...
private:
    ...
    Node* head;
    Node* tail;
    friend ostream& operator <<(ostream& out, const Vector& list);
    friend istream& operator >> (istream& in, const Vector& list);
    Iterator begin;
    Iterator end;
public:
...
istream& operator >> (istream& in, const Vector& list) {
